...
public class Presentation extends JFrame {
    private final Backend DBConnect;
    ...
    public Presentation() {
        ...
        jbFaculty.addActionListener(ae -> {
            boolean loggedIn;

            // Performs Faculty Log-In Check
            ...
            if (loggedIn) {
                ...
                // Loops user through selection menu
                while (working) {
                    ...
                    switch (response) {
                        ...
                        default -> working = false; // Exit Selection Menu & End the Loop
                    }
                }
            }
        });
        ...
        jbStudent.addActionListener(ae -> {
            boolean loggedIn;

            // Performs Student Log-In Check
        ...
        jbExit.addActionListener(ae -> {
            DBConnect.close(); // Exits the program.
        });
    ...
    /**
     * Handles connecting to the database via dialog to collect user login information.
     */
    public void connect() {
    ...
    /**
     * Adds a faculty member via dialog
     *
     * @return If the faculty member was added successfully or not.
     */
    ...
    /**
     * Validates a faculty member is in the system via dialog
     *
     * @return If a given faculty member ID is valid or not
     */
    ...
    /**
     * Adds a student to the system via dialog
     *
     * @return If the student was added succesfully or not
     */
    ...
    /**
     * Validates a student is in the system via dialog
     *
     * @return If the student ID provided is known & valid or not
     */
    ...
    /**
     * Adds a new Abstract to the currently active Faculty Member via Dialog
     */
    ...
    /**
     * Imports abstract text from a file
     *
    ...
    /**
     * Reads all lines in a given file as a String via a provided reader
     *
    ...
    /**
     * Searches for up to 3 keyword(s) across the appropriate user type via dialog.
     *
     * @param type User type searched, "student" or "faculty"
     */
    public void searchKeywords(String type) {
        ...
        try {
            if ((Objects.equals(two, "") || two == null) && (Objects.equals(three, "") || three == null)) {
                DBConnect.searchKeywords(type, one, "", "");
            } else if (Objects.equals(three, "") || three == null) {
                DBConnect.searchKeywords(type, one, two, "");
            } else {
                DBConnect.searchKeywords(type, one, two, three);
            }
        } catch (Exception e) {
    ...
    /**
     * Adds a keyword to the appropriate user type via dialog
     *
     * @param type User type to gain a keyword, "student" or "faculty"
     */
    ...
    /**
     * Removes a keyword to the appropriate user type via dialog
     *
     * @param type User type to have their keyword removed, "student" or "faculty"
     */
